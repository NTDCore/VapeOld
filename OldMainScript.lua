...
local function GetURLOld(scripturl)
	if shared.VapeDeveloper then
		return readfile("vape/"..scripturl)
	else
		return game:HttpGet("https://raw.githubusercontent.com/NTDCore/VapeOld/main/"..scripturl, true)
	end
end
...
local GuiLibrary = loadstring(GetURLOld("OldGuiLibrary.lua"))()
